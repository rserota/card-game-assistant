...
// nemesis cards from Legacy - 22
    new BossCard('Endless Chasm','Power',1,'Legacy',2,'basic'),
    new BossCard('Creeping Curse','Power',1,'Legacy',3,'basic'),
    new BossCard('Spine Thresher','Minion',1,'Legacy',1,'basic'),
    new BossCard('Daze','Attack',1,'Legacy',null,'basic'),
    new BossCard('Ambush','Attack',1,'Legacy',null,'basic'),
    new BossCard('Conduct','Attack',1,'Legacy',null,'basic'),
    new BossCard('Ravenous Leviathan','Minion',1,'Legacy',6,'basic'),
    new BossCard('Aether Extract','Power',1,'Legacy',2,'basic'),
    new BossCard('Hunted','Attack',2,'Legacy',null,'basic'),
    new BossCard('Drain','Attack',2,'Legacy',null,'basic'),
    new BossCard('Sap','Attack',2,'Legacy',null,'basic'),
    new BossCard('Humming Hive','Minion',2,'Legacy',5,'basic'),
    new BossCard('Caustic Cocoon','Minion',2,'Legacy',9,'basic'),
    new BossCard('Tremor','Power',1,'Legacy',2,'basic'),
    new BossCard('Tempting Offer','Power',1,'Legacy',3,'basic'),
    new BossCard('Annihilate','Attack',3,'Legacy',null,'basic'),
    new BossCard('Scatter','Attack',3,'Legacy',null,'basic'),
    new BossCard('Suffocate','Attack',3,'Legacy',null,'basic'),
    new BossCard('Maddening Spectre','Minion',3,'Legacy',7,'basic'),
    new BossCard('Facet Ogre','Minion',3,'Legacy',1,'basic'),
    new BossCard('Flash of Decay','Power',1,'Legacy',2,'basic'),
    new BossCard('Gathering Storm','Power',1,'Legacy',2,'basic'),

// nemesis cards from Buried Secrets - 9
    new BossCard('Hex of Vulnerability','Power',1,'BS',3,'basic'),
    new BossCard('Depreciate','Power',2,'BS',2,'basic'),
    new BossCard('Breach Tunnel','Power',3,'BS',4,'basic'),
    new BossCard('Blade Storm','Attack',1,'BS',null,'basic'),
    new BossCard('Divert','Attack',1,'BS',null,'basic'),
    new BossCard('Muster','Attack',2,'BS',null,'basic'),
    new BossCard('Throng Commander','Minon',1,'BS',1,'basic'),
    new BossCard('Armored Haze','Minon',2,'BS',1,'basic'),
    new BossCard('Mailed Shade','Minon',3,'BS',8,'basic',true),
    ...
    //legacy bosses
    new BossCard('Vile Impaler','Minion',1,'Legacy',5,'Bladius'),
    new BossCard('Lunge','Attack',1,'Legacy',null,'Bladius'),
    new BossCard('Parry','Attack',1,'Legacy',null,'Bladius'),
    new BossCard('Hate Hound','Minion',2,'Legacy',7,'Bladius'),
    new BossCard('Voracious Corroders','Minion',2,'Legacy',9,'Bladius'),
    new BossCard('Riposte','Attack',2,'Legacy',null,'Bladius'),
    new BossCard('Iron Charger','Minion',3,'Legacy',13,'Bladius'),
    new BossCard('Fleche','Power',3,'Legacy',2,'Bladius'),
    new BossCard('Flying Guillotine','Power',3,'Legacy',2,'Bladius'),
	
    new BossCard('Thought Quake','Attack',2,'Legacy',null,'Deathmind'),
    new BossCard('Brain Wipe','Attack',3,'Legacy',null,'Deathmind'),
    new BossCard('Mind Feast','Attack',1,'Legacy',null,'Deathmind'),
    new BossCard('Sever Link','Power',0,'Legacy',3,'Deathmind',true),
    new BossCard('Memory Burst','Power',1,'Legacy',3,'Deathmind'),
    new BossCard("Brama's Torment",'Power',2,'Legacy',2,'Deathmind'),
    new BossCard('Thoughtful Sacrifice','Power',3,'Legacy',2,'Deathmind'),
    new BossCard('Nightmare','Minion',3,'Legacy',17,'Deathmind'),
    new BossCard('Cortex Jailer','Minion',2,'Legacy',4,'Deathmind'),
    new BossCard('Kinetic Construct','Minion',1,'Legacy',7,'Deathmind'),
	
    new BossCard('Deadly Overload','Power',1,'Legacy',3,'Fungal Mesh'),
    new BossCard('Redirected Power','Power',2,'Legacy',3,'Fungal Mesh'),
    new BossCard('Influence','Attack',1,'Legacy',null,'Fungal Mesh'),
    new BossCard('Command','Attack',2,'Legacy',null,'Fungal Mesh'),
    new BossCard('Domineer','Attack',3,'Legacy',null,'Fungal Mesh'),
    new BossCard('Override','Attack',3,'Legacy',null,'Fungal Mesh'),
    new BossCard('Dominion Spores','Minion',1,'Legacy',6,'Fungal Mesh'),
    new BossCard('Brama,Infested','Minion',2,'Legacy',10,'Fungal Mesh'),
    new BossCard('Psychic Clouds','Minion',3,'Legacy',15,'Fungal Mesh'),
	
    new BossCard('Venomous Coil','Power',1,'Legacy',3,'Maelstrom: Risen'),
    new BossCard('Slice','Power',1,'Legacy',3,'Maelstrom: Risen'),
    new BossCard('Ferocious Assault','Power',2,'Legacy',3,'Maelstrom: Risen'),
    new BossCard('Cracking Earth','Power',3,'Legacy',2,'Maelstrom: Risen'),
    new BossCard('Blight','Attack',2,'Legacy',null,'Maelstrom: Risen'),
    new BossCard('Erupt','Attack',3,'Legacy',null,'Maelstrom: Risen'),
    new BossCard('Whipping Wires','Minion',1,'Legacy',7,'Maelstrom: Risen'),
    new BossCard('Bladius','Minion',2,'Legacy',14,'Maelstrom: Risen'),
    new BossCard('Beast of Blades','Minion',3,'Legacy',17,'Maelstrom: Risen'),

    new BossCard('Exterminating Blade','Power',2,'Legacy',3,'Spawning Horror'),
    new BossCard('Accelerated Breeding','Power',2,'Legacy',2,'Spawning Horror'),
    new BossCard('Organic Forge','Power',3,'Legacy',2,'Spawning Horror'),
    new BossCard('Amplify Energy','Power',1,'Legacy',3,'Spawning Horror'),
    new BossCard('Nest Defender','Minion',3,'Legacy',11,'Spawning Horror'),	
    new BossCard('Unearth','Attack',1,'Legacy',null,'Spawning Horror'),
    new BossCard('Construct','Attack',1,'Legacy',null,'Spawning Horror'),
    new BossCard('Retribution','Attack',2,'Legacy',null,'Spawning Horror'),
    new BossCard('Summon','Attack',3,'Legacy',null,'Spawning Horror'),

    new BossCard('Beginning','Attack',1,'Legacy',null,'Xaxos: Ascended'),
    new BossCard('Firestorm','Attack',2,'Legacy',null,'Xaxos: Ascended'),
    new BossCard('Break','Attack',3,'Legacy',null,'Xaxos: Ascended'),
    new BossCard('Inner Eye','Power',2,'Legacy',2,'Xaxos: Ascended'),
    new BossCard('Final Form','Power',3,'Legacy',2,'Xaxos: Ascended'),
    new BossCard('Prelatus of Pain','Minion',1,'Legacy',6,'Xaxos: Ascended'),
    new BossCard('Prelatus of Fire','Minion',1,'Legacy',7,'Xaxos: Ascended'),
    new BossCard('Prelatus of Lore','Minion',2,'Legacy',15,'Xaxos: Ascended'),
    new BossCard('Prelatus of Death','Minion',3,'Legacy',24,'Xaxos: Ascended')
	
//placeholders for ease of future additions
//    new BossCard('PLACEHOLDER','Attack',1,'Legacy',null,'basic'),
//    new BossCard('PLACEHOLDER','Power',1,'Legacy',2,'basic'),
//    new BossCard('PLACEHOLDER','Minion',1,'Legacy',2,'basic'),
]
